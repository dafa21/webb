...
import DKMLogin from "./components/DKMLogin";
import DKMDashboard from "./components/DKMDashboard";
import PengajuanBantuan from "./components/PengajuanBantuan";
import { MosqueProfiles, MOSQUES, MosqueCard } from "./components/MosqueProfiles";
import { KenclengMasjidCarousel } from "./components/KenclengMasjidCarousel";
import { TamanJariyahBanner } from "./components/TamanJariyahBanner";
          ...
          {p.collected >= p.target ? (
            ...
            <>
              ...
              <div className="flex gap-2">
                ...
                >
                  <HandHeart className="w-3.5 h-3.5 fill-white/20 shrink-0" />
...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      {/* Navigation */}
      {!location.pathname.startsWith("/program/") && !location.pathname.startsWith("/mindful") && !location.pathname.startsWith("/taman-jariyah") && !location.pathname.startsWith("/dkm-") && (
        <nav
            ...
            >
              ...
              <div className="flex-1 p-5 lg:p-6 flex flex-col gap-2 overflow-y-auto">
                {[
                  ...
                  { name: "Portal DKM", icon: LayoutDashboard, path: "/dkm-login" },
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <>
                    ...
                    <div className="grid grid-cols-4 gap-y-6 md:gap-y-8 gap-x-2 md:gap-x-4">
                      {[
                        ...
                        },
                        {
                          ...
                          pingCoreColor: "bg-cyan-500",
                        },
                        {
                          icon: LayoutDashboard,
                          label: "Portal DKM",
                          color:
                            "from-slate-700 to-slate-800 text-white shadow-slate-800/20",
                          link: "/dkm-login",
                        },
                        {
                          icon: Sparkles,
                          ...
                          <div className="relative border-none">
                            ...
                            {menu.isNew && (
                              <span className="absolute -top-1 -right-1 flex h-3 w-3 z-20">
                                <span className={`animate-ping absolute inline-flex h-full w-full rounded-full ${menu.pingColor} opacity-75`}></span>
                                <span className={`relative inline-flex rounded-full h-3 w-3 ${menu.pingCoreColor}`}></span>
                              </span>
                            )}
                          </div>
              ...
              <section className="py-16 bg-white dark:bg-slate-900 transition-colors duration-300 relative border-b border-slate-100 dark:border-slate-800">
                {/* Visual Anchor for Gamified Element */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#1799dc]/5 dark:bg-[#1799dc]/10 rounded-full blur-[80px] pointer-events-none"></div>
                <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
                  ...
                  <p className="text-slate-500 font-medium mb-4 text-sm md:text-base">
                    Sedekah Bantu Pembangunan, Renovasi, Operasional, & Dakwah Masjid
                  </p>
                  <div className="w-16 h-1.5 bg-[#1799dc] mx-auto rounded-full mb-8"></div>

                  <KenclengMasjidCarousel 
                    onAddToCart={handleAddToCart}
                    onQuickDonate={(prog, amt) => {
                  ...
                  <motion.button
                    ...
                    className="mt-6 transition-all duration-300 border border-[#1799dc] text-[#1799dc] font-bold px-8 py-3.5 rounded-full hover:bg-blue-50 dark:hover:bg-blue-900/40 text-sm shadow-sm hover:shadow-lg"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.95 }}
                  >
                      ...
                      {[...prayers, ...prayers].map((prayer, i) => (
                        ...
                        >
                          <div className="absolute -top-3 -right-3 w-10 h-10 bg-gradient-to-br from-primary-100 to-primary-50 dark:from-primary-900/40 dark:to-primary-800/20 rounded-full flex items-center justify-center border-2 border-white dark:border-slate-800 shadow-sm rotate-12 group-hover:rotate-0 transition-transform">
                            <HandHeart className="w-4 h-4 text-primary-500 fill-primary-500/20" />
                          </div>
        ...
        <Route path="/quran/:tab" element={<QuranPage />} />
        <Route path="/amaliyah" element={<AmaliyahPage onAddToCart={(item: any, amt?: string) => handleAddToCart(item, amt || item.price?.toString() || '0')} />} />
        ...
        <Route path="/history" element={<DonationHistory userDonations={userDonations} />} />
        <Route path="/dkm-login" element={<DKMLogin />} />
        <Route path="/dkm-dashboard" element={<DKMDashboard />} />
        <Route path="/dkm-dashboard/:tab" element={<DKMDashboard />} />
      ...
      {/* Footer */}
      {!location.pathname.startsWith("/program/") && !location.pathname.startsWith("/mindful") && !location.pathname.startsWith("/taman-jariyah") && !location.pathname.startsWith("/dkm-") && !location.pathname.match(/^\/toko\/.+/) && (
      ...
      {!location.pathname.startsWith("/program/") && !location.pathname.startsWith("/mindful") && !location.pathname.startsWith("/taman-jariyah") && !location.pathname.startsWith("/dkm-") && !location.pathname.match(/^\/toko\/.+/) && (
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 relative">
            ...
            <div className="relative flex flex-col items-center justify-end w-14 h-11">
              <motion.button
                whileTap={{ scale: 0.95 }}
                whileHover={{ scale: 1.05 }}
                onClick={() => {
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        <>
                          ...
                          <HandHeart className="w-5 h-5 fill-white/20 group-hover:scale-110 transition-transform" />
                        </>
                      )}
                    </motion.button>
                  </motion.form>
      ...
      {/* Live Transaction Pop-up */}
      {!mobileMenuOpen && (location.pathname === '/' || location.pathname.startsWith('/program/') || location.pathname === '/masjid') && (
        <LiveDonationToast />
      )}
