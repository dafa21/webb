...
import { MosqueProfiles } from "./components/MosqueProfiles";
...
const PROGRAMS: Program[] = [
  {
    ...
    category: "Sosial",
    description:
      "Bantu alirkan air bersih ke ribuan warga di pelosok Nusantara yang masih kesulitan mendapatkan akses air layak untuk kehidupan sehari-hari.",
    image:
      "https://images.unsplash.com/photo-1504711331083-9c895941bf81?q=80&w=800&auto=format&fit=crop",
  ...
  },
  {
    ...
    category: "Pendidikan",
    description:
      "Dukung para santri yatim dan dhuafa mewujudkan cita-citanya sebagai penghafal Al-Quran melalui beasiswa pendidikan berkelanjutan.",
    image:
  ...
  },
  {
    ...
    description:
      "Salurkan bantuan pangan mendesak untuk saudara kita di Gaza yang saat ini mengalami krisis kemanusiaan parah akibat konflik. Sedekah sahabat adalah harapan mereka.",
    image:
  ...
  },
  {
    ...
    category: "Qurban",
    description:
      "Bahagiakan saudara di pelosok dengan kelezatan daging qurban. Titipkan qurban terbaikmu untuk mereka yang jarang menikmati daging selain saat Idul Adha.",
    image:
      "https://images.unsplash.com/photo-1625488427958-38a4d46c871c?q=80&w=800&auto=format&fit=crop",
    collected: 120000000,
    target: 500000000,
    donors: 45,
  },
  {
    ...
    category: "Sosial",
    description:
      "Alhamdulillah sumur telah selesai dibangun dan air bersih sudah mengalir untuk warga Desa Sukamaju. Terima kasih orang baik!",
    image:
      "https://images.unsplash.com/photo-1590492804562-b91b5c92822a?q=80&w=800&auto=format&fit=crop",
    collected: 50000000,
    target: 50000000,
    donors: 312,
  },
...
export const EXTENDED_PROGRAMS: Program[] = Array.from({ length: 30 }).map(
  (_, i) => ({
...
const PROGRAM_KATEGORIS = [
  {
    title: "Infak Dunia Islam",
    image:
      "https://images.unsplash.com/photo-1542816417-0983c9c9ad53?auto=format&fit=crop&q=80&w=400&h=600",
  },
  {
    title: "Sedekah Subuh",
    image:
      "https://images.unsplash.com/photo-1511553677255-ba939e5537e0?auto=format&fit=crop&q=80&w=400&h=600",
  },
  {
    title: "Zakat",
    image:
      "https://images.unsplash.com/photo-1532372320572-cda25653a26d?auto=format&fit=crop&q=80&w=400&h=600",
  },
  {
    title: "Infaq Rutin",
    image:
      "https://images.unsplash.com/photo-1579621970588-a35d0e7ab9b6?auto=format&fit=crop&q=80&w=400&h=600",
  },
];
...
const STORIES = [
  {
    id: 1,
    image:
      "https://images.unsplash.com/photo-1542816417-0983c9c9ad53?auto=format&fit=crop&q=80&w=150&h=150",
  },
  {
    id: 2,
    image:
      "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?auto=format&fit=crop&q=80&w=150&h=150",
  },
  {
    id: 3,
    image:
      "https://images.unsplash.com/photo-1579621970588-a35d0e7ab9b6?auto=format&fit=crop&q=80&w=150&h=150",
  },
  {
    id: 4,
    image:
      "https://images.unsplash.com/photo-1511553677255-ba939e5537e0?auto=format&fit=crop&q=80&w=150&h=150",
  },
];
...
const DONATION_HISTORY = [
  {
    ...
    method: "Qris",
    impact:
      "Dana Anda difokuskan untuk pipanisasi sepanjang 1km di Desa Suka Maju yang mengalir ke 50 KK.",
  },
  {
    id: "TRX-09821",
    ...
    impact:
      "Telah disalurkan dalam bentuk 2 paket gandum dan susu bayi di pengungsian Rafah.",
  },
  {
    id: "TRX-08211",
    ...
    impact:
      "Disalurkan untuk program pemberdayaan 3 mustahik binaan (Modal Usaha Ayam Petelur).",
  },
  {
    id: "TRX-11002",
...
const SISTER_STORIES = [
  {
    ...
    quote:
      "Terima kasih kakak-kakak dari Indonesia. Berkat makanan ini, adik-adikku tidak menangis kelaparan lagi malam ini.",
  ...
  },
  {
    ...
    quote:
      "Bertahun-tahun kami harus berjalan 3 kilometer untuk air bersih. Kini air mengalir deras di desa kami. Alhamdulillah.",
  ...
  },
  {
    ...
    quote:
      "Beasiswa ini membuat saya bisa terus menghafal Al-Quran tanpa membebani ibu yang berjuang sendiri.",
...
const GALLERY_ITEMS = [
  {
    id: 1,
    type: "video",
    image: "1488521787991-ed7bbaae773c",
    span: "col-span-2 row-span-2",
    title: "Keceriaan Anak-Anak Gaza",
    desc: "Berkat bantuan Anda, penyaluran pangan darurat telah sampai kepada mereka yang membutuhkan di pengungsian.",
  },
  {
    id: 2,
    type: "image",
    image: "1582213787181-42ba2c24efb4",
    span: "col-span-1 row-span-1",
    title: "Pembangunan Sumur",
    desc: "Air bersih kembali mengalir di desa kekeringan.",
  },
  {
    id: 3,
    type: "image",
    image: "1593113565637-29d6bece142a",
    span: "col-span-1 row-span-2",
    title: "Penyaluran Qurban",
    desc: "Pembagian daging qurban kepada masyarakat pedalaman.",
  },
  {
    id: 4,
    type: "image",
    image: "1532372320572-cda25653a26d",
    span: "col-span-1 row-span-1",
    title: "Beasiswa Tahfidz",
    desc: "Para santri semakin semangat menghafal Al-Quran.",
  },
  {
    id: 5,
    type: "video",
    image: "1504711331083-9c895941bf81",
    span: "col-span-2 row-span-1",
    title: "Semangat Belajar di Pelosok",
    desc: "Bantuan perlengkapan sekolah untuk anak-anak cerdas Nusantara.",
  },
] as const;
...
const NOTIFICATIONS = [
  {
    ...
    message:
      "Alhamdulillah! Pipa sepanjang 1km yang Anda bantu danai kini mulai beroperasi. Warga Desa Suka Maju sangat bersyukur.",
  ...
  },
  {
    ...
    message:
      "Sebanyak tatusan Mustahik menerima manfaat Zakat Anda. Terima kasih!",
...
const INITIAL_PRAYERS = [
  {
    ...
    name: "Hamba Allah",
    message:
      "Semoga qurban tahun ini membawa keberkahan untuk kita semua. Aamiin.",
    timeAgo: "Baru saja",
    amins: 12,
  },
  {
    ...
    name: "Budi Santoso",
    message:
      "Bismillah, sedikit rezeki untuk saudara kita di Palestina. Semoga Allah lindungi mereka.",
  ...
  },
  {
    ...
    name: "Keluarga Ahmad",
    message:
      "Semoga sumur air bersihnya cepat selesai dan bermanfaat bagi warga pelosok Jabar.",
  ...
  },
  {
    ...
    name: "Hamba Allah",
    message:
      "Niat zakat penghasilan bulan ini. Semoga mensucikan harta keluarga kami.",
  ...
  },
  {
    ...
    name: "Siti Rahmawati",
    message:
      "Ya Allah, jadikanlah sedekah ini sebagai jariyah untuk almarhum ayah hamba.",
  ...
  },
  {
    id: 6,
    name: "Deni & Istri",
    message: "Semoga adik-adik santri tetap semangat menghafal Al-Quran yah!",
...
export const PAYMENT_METHODS = [
  {
    id: "gopay",
    name: "GoPay",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Payment%20Channel/E-Wallet/Gopay.svg",
    desc: "Instan",
  },
  {
    id: "shopeepay",
    name: "ShopeePay",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Payment%20Channel/E-Wallet/Shopee%20Pay.svg",
    desc: "Instan",
  },
  {
    id: "ovo",
    name: "OVO",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Payment%20Channel/E-Wallet/OVO.svg",
    desc: "Instan",
  },
  {
    id: "dana",
    name: "DANA",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Payment%20Channel/E-Wallet/DANA.svg",
    desc: "Instan",
  },
  {
    id: "linkaja",
    name: "LinkAja",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Payment%20Channel/E-Wallet/LinkAja.svg",
    desc: "Instan",
  },
  {
    id: "bca_va",
    name: "BCA VA",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Bank/Bank%20Logo/BCA.svg",
    desc: "Virtual Account",
  },
  {
    id: "mandiri_va",
    name: "Mandiri VA",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Bank/Bank%20Logo/Mandiri.svg",
    desc: "Virtual Account",
  },
  {
    id: "bri_va",
    name: "BRI VA",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Bank/Bank%20Logo/BRI.svg",
    desc: "Virtual Account",
  },
  {
    id: "bni_va",
    name: "BNI VA",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Bank/Bank%20Logo/BNI.svg",
    desc: "Virtual Account",
  },
  {
    id: "bsi_va",
    name: "BSI VA",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Bank/Bank%20Logo/BSI.svg",
    desc: "Virtual Account",
  },
  {
    id: "qris",
    name: "QRIS",
    icon: "https://raw.githubusercontent.com/Zyknn/paymentlogo/main/Payment%20Channel/Miscellaneous/QRIS.svg",
    desc: "Semua E-Wallet",
  },
];
...
export const formatCurrencyForm = (val: string) => {
  if (!val) return "";
...
}> = ({ p, index, onQuickDonate, onAddToCart }) => {
  const [localDonationAmount, setLocalDonationAmount] = useState(
      ...
      <div className="p-4 md:p-5 flex-1 flex flex-col bg-white dark:bg-slate-800">
        ...
        <div className="mb-4">
          ...
          <div className="flex justify-between items-center text-[10px] md:text-xs">
            ...
            <span className="text-[#1799dc] font-bold">
        ...
        <div className="mt-auto pt-2 flex flex-col gap-2 md:gap-3">
          {p.collected >= p.target ? (
            <div className="flex flex-col gap-2 mt-2">
              ...
              <Link
                to={`/program/${p.id}`}
                className="w-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 font-bold text-center text-[11px] md:text-[13px] py-2 md:py-2.5 rounded-full transition-colors flex justify-center items-center h-8 md:h-10"
              >
                Lihat Detail
              </Link>
            </div>
...
const LIVE_TRANSACTIONS = [
  {
    name: "Hamba Allah",
    action: "baru saja berqurban 1 Kambing untuk Orang Tua",
    time: "Baru saja",
    icon: "Tent",
  },
  {
    name: "Siti F.",
    action: "baru saja menyalurkan Sedekah Subuh Rp 50.000",
    time: "1 menit yang lalu",
    icon: "TrendingUp",
  },
  {
    name: "Bapak Budi",
    action: "ikut patungan Pembangunan Sumur",
    time: "2 menit yang lalu",
    icon: "Droplets",
  },
  {
    name: "Keluarga Yanto",
    action: "berdonasi untuk Palestina Rp 500.000",
    time: "3 menit yang lalu",
    icon: "Globe",
  },
  {
    name: "Hamba Allah",
    action: "baru saja menunaikan Zakat Penghasilan",
    time: "5 menit yang lalu",
    icon: "HandCoins",
  },
  {
    name: "Ananda D.",
    action: "berdonasi Beasiswa Tahfidz",
  ...
  const filteredPrograms = EXTENDED_PROGRAMS.filter((p) => {
    ...
    const matchesStatus =
      activeStatusFilter === "Semua"
        ? true
        : getProgramStatus(p) === activeStatusFilter;
  ...
  return (
    <div className="pt-24 md:pt-32 pb-24 min-h-screen bg-[#eaf4fc]/40 dark:bg-slate-950 px-4 max-w-7xl mx-auto">
      <div className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-serif font-black text-slate-900 dark:text-white mb-4">
          Semua Program
        </h1>
        <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base leading-relaxed mb-6">
          Pilih ladang pahala Anda. Setiap donasi memberikan dampak nyata bagi
      ...
      <div className="flex flex-col gap-4 mb-8 md:mb-10">
        <div className="flex justify-center mb-2">
          ...
          >
            ...
            Filter Program{" "}
            {(activeFilter !== "Semua" || activeStatusFilter !== "Semua") && (
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 md:gap-3">
                {filters.map((filter) => {
                  ...
                  return (
                    ...
                    >
                      <Icon
                        className={`w-4 h-4 ${activeFilter === filter.id ? "text-white" : "text-[#1799dc]"}`}
                      />
                      {filter.id}
                    </button>
                  );
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 md:gap-3 lg:pb-2">
                {statusFilters.map((filter) => {
                  ...
                  return (
                    ...
                    >
                      <Icon
                        className={`w-4 h-4 ${activeStatusFilter === filter.id ? "text-white dark:text-slate-900" : "text-slate-500 dark:text-slate-400"}`}
                      />
                      {filter.id}
                    </button>
                  );
...
export default function App() {
  ...
  const handleAddToCart = (p: Program, amt: string) => {
    setCartItems((prev) => {
      ...
      if (existingIndex >= 0) {
        ...
        updated[existingIndex].amount = (
          parseInt(updated[existingIndex].amount) + parseInt(amt)
        ).toString();
        return updated;
      }
    ...
    setToastMessage(
      `Alhamdulillah, ${p.title} berhasil dititipkan ke Kantung Kebaikan!`,
    );
    setShowToast(true);
  ...
  const [toastMessage, setToastMessage] = useState(
    "Alhamdulillah, Donasi Anda Telah Diterima!",
  );
  const [cartItems, setCartItems] = useState<
    { id: string; program: Program; amount: string }[]
  >([]);
  ...
  useEffect(() => {
    if (isDonationSuccess && "speechSynthesis" in window) {
      ...
      const prayerText =
        "Alhamdulillah. Jazakumullahu Khairan Sahabat Dakwah. Semoga Allah memberikan pahala atas apa yang engkau berikan, dan memberikan keberkahan atas apa yang engkau simpan, serta menjadikannya sebagai pembersih bagimu. Aamiin yaa robbal 'aalamiin.";
  ...
  const finishDonation = async () => {
    ...
    const defaults = {
      ...
      ticks: 60,
      zIndex: 2000,
      colors: ["#10b981", "#059669", "#f59e0b", "#fbbf24", "#fcd34d"],
    };
  ...
  const [impactTab, setImpactTab] = useState<
    "infografis" | "peta" | "peta_qurban" | "galeri"
  >("infografis");
  ...
  const [zakatTab, setZakatTab] = useState<
    "penghasilan" | "maal" | "perdagangan" | "saham" | "rikaz" | "fidyah"
  >("penghasilan");
  ...
  const handleAamiin = (id: number) => {
    setPrayers((prev) =>
      prev.map((p) => (p.id === id ? { ...p, amins: p.amins + 1 } : p)),
    );
  };
  ...
  const handleGeneratePrayer = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents:
          "Rangkaikan doa yang singkat (maks 2-3 kalimat), menyentuh, islami, dan tulus untuk penerima infak/sedekah dan kebaikan donatur. Bahasa Indonesia. Jangan pakai koma atau kutip berlebihan.",
      });
      if (response.text) {
  ...
  const getZakatDetails = () => {
    ...
    if (zakatTab === "penghasilan") {
      ...
      if (isEligible) zakatAmmount = totalAsset * 0.2;
  ...
  const {
    totalAsset,
    requiredNisab,
    isEligible: isEligibleZakat,
    zakatAmmount: zakatToPay,
  } = getZakatDetails();
  ...
  return (
    <div className="min-h-screen font-sans">
      <AnimatePresence>
        {!isFirestoreConnected && (
          ...
          >
            ...
            <span>
              Sedang dalam mode offline. Beberapa fitur mungkin tertunda hingga
              koneksi pulih.
            </span>
          </motion.div>
        )}
          ...
          >
            <div className="bg-emerald-500 rounded-xl shadow-2xl p-4 flex items-center justify-between">
              ...
              <motion.button
                ...
                className="transition-all duration-300 text-white/80 hover:text-white transition-colors p-1 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:brightness-110 active:scale-95"
              >
                <X className="w-4 h-4" />
              </motion.button>
            </div>
      ...
      {!location.pathname.startsWith("/program/") && (
        ...
        >
          <div
            className={`max-w-7xl mx-auto flex items-center justify-between transition-all duration-500 ease-in-out rounded-full ${
              isScrolled
          ...
          >
            ...
            >
              <img
                src="/logo-kecil (1).png"
                alt="Logo"
                className={`h-7 md:h-8 object-contain transition-all duration-300 dark:brightness-0 dark:invert dark:drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]`}
              />
            </div>

            <div
              className={`${isSearchOpen ? "w-full md:w-auto" : ""} flex items-center gap-1.5 md:gap-2`}
            >
              <div
                className={`relative ${isSearchOpen ? "w-full flex-1" : ""}`}
              >
                {isSearchOpen ? (
                  <motion.div
                        ...
                        {searchQuery.trim().length > 0 && (
                          ...
                          >
                            {(() => {
                              ...
                              const progs = EXTENDED_PROGRAMS.filter(
                                (p) =>
                                  p.title.toLowerCase().includes(query) ||
                              ...
                              return (
                                <div className="py-2">
                                  {pages.length > 0 && (
                                    <div className="mb-2">
                                      <h4 className="px-4 py-1 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                                        Fitur Aplikasi
                                      </h4>
                                      {pages.map((p, i) => {
                                        const Icon = p.icon;
                                      ...
                                      {progs.map((p) => (
                                        ...
                                        >
                                          ...
                                          <div className="overflow-hidden">
                                            <h5 className="text-sm font-bold text-slate-700 dark:text-slate-200 truncate">
                                              {p.title}
                                            </h5>
                  ...
                  <motion.button
                    ...
                    className={`transition-all duration-300 relative flex items-center justify-center rounded-full transition-all duration-300 ${
                      isScrolled
                        ? "w-8 h-8 xl:w-9 xl:h-9 hover:bg-black/5 dark:hover:bg-white/10 text-slate-700 dark:text-slate-200"
                        : "w-8 h-8 xl:w-9 xl:h-9 bg-white dark:bg-slate-800 shadow-lg shadow-black/5 border border-white/40 dark:border-slate-700 text-primary-500 hover:scale-105"
                    }`}
                  >
              ...
              >
                ...
                {cartItems.length > 0 && (
                  <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[8px] xl:text-[9px] w-3.5 h-3.5 md:w-3.5 md:h-3.5 xl:w-4 xl:h-4 rounded-full flex items-center justify-center font-bold shadow-sm border border-white dark:border-slate-900 pointer-events-none">
                    {cartItems.length}
                  </span>
                )}
              </motion.button>
              ...
              <div
                className={`relative ${isSearchOpen ? "hidden md:block" : ""} md:hidden`}
              >
                <motion.button
                  whileTap={{ scale: 0.95 }}
                  whileHover={{ scale: 1.05 }}
                  ...
                  {notificationsOpen && (
                    ...
                    >
                      <div className="p-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                        ...
                        <motion.button
                          className="transition-all duration-300 text-xs text-primary-600 font-semibold hover:underline transition-all duration-300 hover:shadow-lg"
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.95 }}
                        >
                          Tandai sudah dibaca
                      ...
                      <div className="max-h-[300px] overflow-y-auto">
                        {NOTIFICATIONS.map((notif) => (
                          <div
                            key={notif.id}
                            className={`p-4 border-b border-slate-50 hover:bg-slate-50 transition-colors cursor-pointer flex gap-3 ${!notif.read ? "bg-primary-50/30" : ""}`}
                          >
                            <div
                              className={`w-2 h-2 rounded-full mt-1.5 shrink-0 ${!notif.read ? "bg-primary-500" : "bg-slate-300"}`}
                            ></div>
                            <div>
                              <h4
                                className={`text-sm ${!notif.read ? "font-bold text-slate-900" : "font-semibold text-slate-700"} mb-1`}
                              >
                                {notif.title}
                              </h4>
                      ...
                      <div className="p-3 bg-slate-50 border-t border-slate-100 text-center">
                        <motion.button
                          className="transition-all duration-300 text-xs font-bold text-slate-600 hover:text-primary-600 transition-all duration-300 hover:shadow-lg"
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.95 }}
                        >
              ...
              <motion.button
                ...
                className={`transition-all duration-300 ${isSearchOpen ? "hidden" : "flex"} items-center justify-center gap-2 rounded-full transition-all duration-300 ${
                  isScrolled
                    ? "px-2.5 md:px-3 h-8 md:h-9 hover:bg-black/5 dark:hover:bg-white/10 text-slate-700 dark:text-slate-200"
                    : "px-3 md:px-4 h-8 md:h-9 bg-white dark:bg-slate-800 shadow-lg shadow-black/5 border border-white/40 dark:border-slate-700 text-primary-500 hover:scale-105"
                } transition-all duration-300 hover:scale-105 hover:shadow-lg hover:brightness-110 active:scale-95`}
              >
                <span className="hidden sm:inline font-bold text-[10px] uppercase tracking-widest mt-0.5">
                  Menu
                </span>
            ...
            >
              <div className="p-4 flex justify-between items-center bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800">
                <div className="flex items-center gap-2">
                  <img
                    src="/logo-kecil (1).png"
                    alt="Logo"
                    className="h-8 object-contain dark:brightness-0 dark:invert dark:drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]"
                  />
                </div>
                <motion.button
                  whileTap={{ scale: 0.95 }}
              ...
              <div className="flex-1 p-5 lg:p-6 flex flex-col gap-2 overflow-y-auto">
                ...
                >
                  ...
                  <div
                    className={`shrink-0 w-9 h-5 rounded-full flex items-center transition-colors ${isDarkMode ? "bg-[#1799dc]" : "bg-slate-300 dark:bg-slate-700"}`}
                  >
                    <div
                      className={`w-3.5 h-3.5 bg-white rounded-full mx-0.5 shadow-sm transform transition-transform ${isDarkMode ? "translate-x-4" : "translate-x-0"}`}
                    ></div>
                  </div>
                </motion.button>
                ...
                <div className="mt-auto pt-8 flex flex-col gap-3">
                  <motion.button
                    className="w-full py-3.5 rounded-xl bg-[#1799dc] hover:bg-[#1588c4] active:bg-[#137ab0] text-white font-bold text-base shadow-lg shadow-[#1799dc]/20 transition-all"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    Mulai Sedekah
                  ...
                  <div className="flex justify-center gap-5 text-slate-400 dark:text-slate-500 mt-2 pb-4">
                    <motion.a
                      href="#"
                      className="hover:text-[#1799dc] transition-colors"
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <>
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto px-4 flex flex-col items-center flex-1">
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded-[28px] shadow-2xl shadow-[#1799dc]/10 dark:shadow-slate-900/50 w-full max-w-[850px] mx-auto mt-8 mb-4 relative border border-[#1799dc]/10 dark:border-slate-700 overflow-hidden flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-slate-100 dark:divide-slate-700/50 group">
                    ...
                    <div className="p-5 md:px-6 md:py-6 flex-1 flex items-center justify-between gap-4 bg-gradient-to-br from-white to-slate-50 dark:from-slate-800 dark:to-slate-800/80">
                      <div>
                        <p className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-widest mb-1 flex items-center gap-1.5">
                          <TrendingUp className="w-3.5 h-3.5 text-[#1799dc]" />{" "}
                          Penyaluran
                        </p>
                        <h2 className="text-2xl md:text-3xl font-black text-slate-800 dark:text-white leading-none">
                          26.5{" "}
                      ...
                      <div className="text-right">
                        <p className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-widest mb-1 flex items-center justify-end gap-1.5 justify-end">
                    ...
                    <div className="p-4 md:px-6 md:py-5 flex-[1.2] flex items-center bg-slate-50/50 dark:bg-slate-800/30">
                      ...
                      <div
                        className="flex-1 overflow-hidden h-10 md:h-12 relative cursor-pointer"
                        onClick={() => {
                          document
                            .getElementById("doa-terbaru")
                            ?.scrollIntoView({ behavior: "smooth" });
                        }}
                      >
                        <AnimatePresence mode="popLayout">
                          {showLiveTransaction &&
                          liveTransactionIndex >= 0 &&
                          LIVE_TRANSACTIONS[liveTransactionIndex] ? (
                            <motion.div
                            ...
                            >
                              <p className="text-[11px] md:text-sm text-slate-700 dark:text-slate-300 leading-tight md:leading-snug">
                                <span className="font-bold">
                                  {LIVE_TRANSACTIONS[liveTransactionIndex].name}
                                </span>{" "}
                                {LIVE_TRANSACTIONS[liveTransactionIndex].action}
                              </p>
                              <span className="text-[9px] md:text-[11px] text-slate-400 font-medium md:mt-0.5">
                                {LIVE_TRANSACTIONS[liveTransactionIndex].time}
                              </span>
                            </motion.div>
                          ) : (
                            <motion.div
                              ...
                              className="absolute inset-0 flex flex-col justify-center"
                            >
                              <p className="text-[11px] md:text-sm text-slate-500 dark:text-slate-400 leading-snug">
                                Berbagi kebahagiaan dan siapkan bekal akhirat
                                Anda dengan donasi terbaik hari ini.
                              </p>
                            </motion.div>
                          )}
                        </AnimatePresence>
                      ...
                      {[
                        {
                          ...
                          label: "Al-Qur'an",
                          color:
                            "from-[#1799dc] to-[#127bb0] text-white shadow-[#1799dc]/20",
                          link: "/quran",
                        },
                        {
                          icon: Sparkles,
                          label: "Makhraj",
                          color:
                            "from-emerald-400 to-emerald-500 text-white shadow-emerald-500/20",
                          link: "/quran?tab=makhraj",
                        },
                        {
                          icon: HandCoins,
                          label: "Zakat",
                        ...
                        },
                        {
                          ...
                          label: "Infak/Sedekah",
                          color:
                            "from-[#2db2f5] to-[#1799dc] text-white shadow-[#1799dc]/20",
                          link: "#program",
                        },
                        {
                          icon: Tent,
                          label: "Qurban",
                          color:
                            "from-[#febb22] to-[#f29f05] text-white shadow-[#f29f05]/20",
                          link: "/qurban",
                        },
                        {
                          icon: Building2,
                          label: "Profil Masjid",
                          color:
                            "from-blue-400 to-blue-500 text-white shadow-blue-500/20",
                          link: "/masjid",
                        },
                        {
                          icon: Clock,
                        ...
                        },
                        {
                          ...
                          label: "Cari Masjid",
                          color:
                            "from-cyan-400 to-cyan-500 text-white shadow-cyan-500/20",
                          link: "/mosques",
                        },
                        {
                          icon: Component,
                          label: "Lainnya",
                          color:
                            "from-slate-400 to-slate-500 text-white shadow-slate-500/20 text-xs tracking-wider",
                          link: "#layanan",
                        },
                      ].map((menu, i) => (
                        <div
                          ...
                          onClick={() => {
                            if (menu.link.startsWith("/")) {
                              ...
                              document
                                .getElementById(menu.link.replace("#", ""))
                                ?.scrollIntoView({ behavior: "smooth" });
                            }
                          }}
                        >
                          <div className="relative border-none">
                            <div
                              className={`w-11 h-11 md:w-14 md:h-14 rounded-[16px] bg-gradient-to-br ${menu.color} flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:-translate-y-1 transition-all duration-300 relative z-10 box-border`}
                            >
                              <menu.icon
              ...
              <section
                id="dampak"
                className="bg-slate-50 dark:bg-slate-900 relative pt-16 pb-20 md:py-24 overflow-hidden border-t border-slate-100 dark:border-slate-800 transition-colors duration-300"
              >
                ...
                <div className="max-w-5xl mx-auto px-4 relative z-10 flex flex-col gap-6 md:gap-8">
                  <div className="text-center max-w-2xl mx-auto">
                    <h2 className="text-[10px] md:text-xs font-bold text-[#f29f05] uppercase tracking-[0.2em] mb-3">
                      Visualisasi Dampak Donasi
                    </h2>
                    <h3 className="text-2xl md:text-4xl font-serif font-black text-slate-900 dark:text-white mb-4 tracking-tight leading-[1.15]">
                      Membangun Harapan,
                      <br />
                      Mengubah Kehidupan.
                    </h3>
                    <p className="text-slate-500 dark:text-slate-400 text-xs md:text-sm leading-relaxed px-4">
                      Setiap rupiah yang diamanahkan telah menjadi senyum bagi
                      jutaan penerima manfaat di seluruh penjuru negeri.
                    </p>
                  </div>
                  ...
                  <div className="w-full mb-6 max-w-[100vw] overflow-hidden">
                    <div className="w-full overflow-x-auto hide-scrollbar px-4 md:px-0 pb-2 flex lg:justify-center">
                      <div className="inline-flex flex-nowrap bg-slate-100 dark:bg-slate-800/80 p-1 rounded-full shadow-inner border border-slate-200/50 dark:border-slate-700/50 shrink-0">
                        ...
                        >
                          <MapPin className="w-3.5 h-3.5 md:w-4 md:h-4" /> Peta
                          Program
                        </motion.button>
                        <motion.button
                          whileTap={{ scale: 0.95 }}
                        ...
                        >
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 max-w-4xl mx-auto">
                            {[
                              ...
                              <div
                                key={i}
                                className="bg-white dark:bg-slate-800 rounded-[20px] p-4 text-center border border-slate-200/50 dark:border-slate-700 shadow-sm transition-all group flex flex-col items-center justify-center hover:shadow-md"
                              >
                                <div
                                  className={`w-10 h-10 md:w-12 md:h-12 rounded-[14px] ${stat.bg}10 mb-2.5 flex items-center justify-center group-hover:scale-110 transition-transform`}
                                >
                                  <stat.icon
                                ...
                                <h4
                                  className={`text-2xl md:text-3xl font-black ${stat.color} mb-0.5 tracking-tight`}
                                >
                                  {stat.val}
                                </h4>
                          ...
                          <div className="grid md:grid-cols-2 gap-3 md:gap-4 mt-3 md:mt-4 max-w-4xl mx-auto">
                            ...
                            <div className="bg-white dark:bg-slate-800 rounded-[20px] p-5 md:p-6 border border-slate-200/50 dark:border-slate-700 shadow-sm overflow-hidden flex flex-col">
                              <h4 className="text-[13px] md:text-[15px] font-bold text-slate-800 dark:text-white mb-4 border-b border-slate-50 dark:border-slate-700 pb-2.5">
                            ...
                            <div className="relative rounded-[20px] overflow-hidden bg-slate-900 p-5 md:p-6 shadow-md h-full flex flex-col justify-center border border-slate-800 min-h-[220px]">
                              ...
                              <h4 className="text-[13px] md:text-[15px] font-bold text-white mb-1.5 relative z-10 border-b border-white/10 pb-2.5">
                                Demografi Penerima
                              </h4>
                              <p className="text-slate-400 text-[10px] md:text-[11px] mb-5 relative z-10 leading-relaxed max-w-xs mt-2">
                                Penyaluran difokuskan pada asnaf prioritas dan
                                daerah pelosok.
                              </p>
                              ...
                              <div className="grid grid-cols-2 gap-2.5 relative z-10 mt-auto pt-2">
                                {INFOGRAPHICS.demografi.map((item, i) => (
                                  ...
                                  >
                                    <h5 className="text-lg md:text-xl font-black text-[#f29f05] mb-0.5 group-hover:scale-105 origin-left transition-transform">
                                      {item.count}
                                    </h5>
                              ...
                              >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent opacity-90 group-hover:opacity-100 transition-opacity flex items-end p-3 md:p-4">
                                  <div className="translate-y-1 group-hover:translate-y-0 transition-transform w-full">
                                    <h3 className="text-white font-extrabold text-[11px] md:text-sm leading-tight line-clamp-2 drop-shadow-md">
                                      {item.title}
                                    </h3>
                                  </div>
                                </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-[1.5] relative aspect-video md:aspect-auto md:min-h-[300px]">
                        <img
                          src={`https://images.unsplash.com/photo-${selectedGalleryItem.image}?auto=format&fit=crop&w=1200&q=90`}
                          className="w-full h-full object-cover"
                      ...
                      <div className="flex-1 bg-white dark:bg-slate-800 p-6 md:p-8 flex flex-col justify-center border-l md:border-t-0 border-slate-100 dark:border-slate-700">
                        ...
                        <h3 className="text-xl md:text-2xl font-black text-slate-900 dark:text-white mb-2.5 tracking-tight leading-snug">
                          {selectedGalleryItem.title}
                        </h3>
                        <p className="text-[13px] md:text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
              ...
              <section
                id="layanan"
                className="bg-cream-100 dark:bg-slate-900 pt-32 pb-24 -mt-16 md:mt-0 md:pt-16 relative z-10 transition-colors duration-300"
              >
              ...
              <section className="py-16 bg-white dark:bg-slate-800 transition-colors duration-300">
                <div className="max-w-4xl mx-auto px-4 text-center">
                  <h2 className="text-3xl md:text-4xl font-extrabold text-[#1799dc] mb-2 tracking-tight">
                    Kencleng Masjid Digital
                  </h2>
                  <p className="text-slate-500 font-medium mb-4 text-sm md:text-base">
                    Sedekah Bantu Pembangunan, Renovasi, Operasional, & Dakwah
                    Masjid
                  </p>
                    ...
                    {[1, 2].map((i, index) => (
                      ...
                      >
                        <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-slate-50 shadow-lg mb-4 p-1 group-hover:-translate-y-2 transition-transform">
                          <img
                            src={`https://images.unsplash.com/photo-1565552640578-8386121415f3?q=80&w=200&h=200&auto=format`}
                  ...
                  <motion.button
                    className="transition-all duration-300 border border-primary-600 text-primary-600 font-bold px-8 py-3.5 rounded-full hover:bg-primary-50 text-sm shadow-sm transition-all duration-300 hover:shadow-lg"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.95 }}
                  >
              ...
              <section className="py-16 bg-cream-200 dark:bg-slate-900 text-center relative overflow-hidden transition-colors duration-300">
                ...
                <div className="max-w-3xl mx-auto px-4 relative z-10 flex flex-col items-center">
                  ...
                  <h2 className="text-3xl md:text-5xl font-extrabold text-[#1799dc] mb-6 leading-none tracking-tight">
                    Mari Tunaikan Aqiqah Multi Manfaat{" "}
                    <span className="text-primary-600 block sm:inline mt-2 sm:mt-0">
                      hingga ke Pedalaman
                    </span>
                  </h2>
                  <motion.button
              ...
              <section
                id="program"
                className="py-16 md:py-24 bg-white dark:bg-slate-800 relative transition-colors duration-300"
              >
                <div className="max-w-7xl mx-auto px-4 relative z-10">
                  <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 md:mb-12 relative pb-4">
                    ...
                    <div className="relative z-10 bg-white dark:bg-slate-800 pr-4 md:pr-8 text-left transition-colors duration-300">
                      <h2 className="text-3xl md:text-5xl font-extrabold text-[#1799dc] tracking-tight leading-none mb-1 md:mb-0">
                        Program
                        <br className="hidden md:block" /> Prioritas
                      </h2>
                    </div>
                    <div className="mt-4 sm:mt-0 relative z-10 bg-white dark:bg-slate-800 pl-0 sm:pl-4 transition-colors duration-300">
                      <motion.button
                        className="transition-all duration-300 text-slate-800 hover:text-primary-600 font-bold flex items-center gap-2 text-sm md:text-base group transition-all duration-300 hover:shadow-lg"
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.95 }}
                      >
                        Lihat Semua{" "}
              ...
              <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-4">
                  <motion.button
                    className="transition-all duration-300 w-20 h-20 bg-accent-500 text-white rounded-full flex items-center justify-center shadow-accent-500/50 shadow-2xl hover:scale-110 transition-transform mb-8 transition-all duration-300 hover:shadow-lg"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <PlayCircle className="w-10 h-10" />
                  </motion.button>
                  <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4 tracking-tight leading-none">
                    Bismillah Bisa Qurban, Kita Jemput Pahala Besar
                  </h2>
                </div>
              </section>
              ...
              <section
                id="doa-terbaru"
                className="py-20 md:py-24 bg-slate-50 dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 relative overflow-hidden"
              >
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10">
                  <div className="text-center mb-12">
                    ...
                    <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 dark:text-white leading-tight tracking-tight mb-4">
                      Titipan Harapan dari
                      <br className="hidden md:block" />
                      Para Pendekar Kebaikan.
                    </h3>
                    <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto text-sm md:text-base">
                      Setiap donasi membawa seuntai doa. Jangan biarkan doa-doa
                      ini mengangkasa sendirian. Bantu aminkan agar pintu langit
                      segera terbuka.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                    <div className="max-w-2xl">
                      <h2 className="text-sm font-bold text-[#f29f05] uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                        <span className="w-8 h-px bg-[#f29f05]"></span> Cerita
                        Sukses
                      </h2>
                      <h3 className="text-3xl md:text-5xl font-serif font-bold text-slate-900 dark:text-white leading-tight tracking-tight">
                        Kisah Mereka,
                        <br className="hidden md:block" />
                        Jejak Kebaikan Anda.
                      </h3>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 max-w-md md:text-right">
                      Di balik setiap angka yang tersalurkan, ada kisah tentang
                      harapan yang kembali menyala dan senyum yang kembali
                      merekah.
                    </p>
                  </div>
                    ...
                    {SISTER_STORIES.map((story, index) => (
                      ...
                      >
                        <div className="relative h-[400px] mb-6 rounded-3xl overflow-hidden shadow-2xl shadow-primary-900/10 border-4 border-white dark:border-slate-800 ring-1 ring-slate-100 dark:ring-slate-700">
                          <img
                            src={story.image}
                            className="w-full h-full object-cover transition-transform hover:scale-105 duration-1000 grayscale-[0.2] hover:grayscale-0"
                            alt={`Cerita ${story.name}`}
                          />
                          ...
                          <div className="absolute bottom-6 left-6 right-6">
                            ...
                            <h4 className="text-white text-xl md:text-2xl font-bold font-serif leading-tight">
                              {story.name}
                            </h4>
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          ...
                          <div className="text-xs text-slate-400 font-medium uppercase tracking-widest pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                            ...
                            <motion.button
                              className="transition-all duration-300 text-primary-600 hover:text-primary-700 font-bold flex items-center gap-1 group/btn transition-all duration-300 hover:shadow-lg"
                              whileHover={{ scale: 1.02 }}
                              whileTap={{ scale: 0.95 }}
                            >
                              Lihat Program{" "}
              ...
              >
                <div className="max-w-7xl mx-auto px-4">
                  <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4 text-center md:text-left">
                    ...
                    <motion.button
                      className="transition-all duration-300 text-primary-600 font-bold hover:bg-primary-50 px-6 py-2 rounded-full text-sm transition-all duration-300 hover:shadow-lg"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.95 }}
                    >
                    ...
                    {[
                      ...
                      >
                        <div className="h-32 md:h-40 overflow-hidden rounded-xl relative mb-3">
                          <img
                            src={`https://images.unsplash.com/photo-${item.image}?q=80&w=400&auto=format&fit=crop`}
                        ...
                        <div className="px-1 pb-1 text-center md:text-left">
                          <p className="text-[9px] md:text-[10px] text-slate-400 font-medium mb-1 uppercase tracking-widest">
                            24 April 2026
                          </p>
                          <h4 className="font-bold text-slate-800 line-clamp-2 md:line-clamp-3 group-hover:text-primary-600 transition-colors mb-2 text-xs md:text-sm leading-snug">
                            Makin Praktis! Laznas Dewan Dakwah Hadirkan Layanan
                            Inovatif
                          </h4>
                          <motion.button
                            className="transition-all duration-300 text-[9px] md:text-[10px] uppercase font-bold text-slate-400 group-hover:text-primary-600 flex items-center justify-center md:justify-start gap-1 w-full tracking-widest transition-all duration-300 hover:shadow-lg"
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.95 }}
                          >
            ...
            <section className="pt-24 pb-16 min-h-[80vh] bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
              <div className="max-w-4xl mx-auto px-4">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
                  <div>
                    <h1 className="text-3xl md:text-4xl font-extrabold text-[#1799dc] mb-2 tracking-tight">
                      Dashboard Donatur
                    </h1>
                    <p className="text-slate-500 font-medium text-sm md:text-base">
                      Melihat jejak kebaikan dan dampak nyata dari sedekah Anda.
                    </p>
                  </div>
                  <div className="bg-primary-100 text-primary-800 font-bold px-5 py-3 rounded-xl flex items-center gap-4 border border-primary-200">
                    ...
                    <div>
                      <div className="text-[10px] uppercase tracking-widest font-bold opacity-80 mb-0.5">
                  ...
                  <div className="bg-white dark:bg-slate-800 p-5 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-2xl font-black text-slate-800 dark:text-slate-100">
                        {new Set(userDonations.map((d) => d.program)).size}
                      </div>
                ...
                <div className="mb-10">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 relative overflow-hidden group">
                      ...
                      <div className="flex justify-between items-start mb-6">
                        ...
                        {(() => {
                          const totalInfak = userDonations
                            .filter(
                              (t: any) =>
                                t.status === "Berhasil" &&
                                typeof t.program === "string" &&
                                !t.program.includes("Zakat"),
                            )
                            .reduce(
                          ...
                          return (
                            <div
                              className={`px-4 py-2 rounded-xl ${currentMilestone.bg} ${currentMilestone.color} font-black text-xs flex items-center gap-2 border border-current/10 shadow-sm`}
                            >
                      ...
                      {(() => {
                        ...
                        const nextMilestone =
                          MILESTONES.find(
                            (m) => m.amount > currentMilestone.amount,
                          ) || null;
                        const progress = nextMilestone
                          ? Math.min(
                              ((totalInfak - currentMilestone.amount) /
                            ...
                            <div className="flex justify-between items-center text-[11px] font-bold">
                              <span className="text-slate-400 uppercase tracking-widest">
                                ...
                                <span className="text-slate-700 dark:text-slate-200">
                                  {formatCurrency(totalInfak)}
                                </span>
                              </span>
                              {nextMilestone && (
                                <span className="text-[#1799dc] uppercase tracking-widest">
                                  Sisa{" "}
                                  <span className="text-slate-700 dark:text-slate-200">
                                    {formatCurrency(
                                      nextMilestone.amount - totalInfak,
                                    )}
                                  </span>{" "}
                                  lagi ke{" "}
                    ...
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 relative overflow-hidden group">
                      ...
                      <div className="flex justify-between items-start mb-6">
                        ...
                        {(() => {
                          const totalZakat = userDonations
                            .filter(
                              (t: any) =>
                                t.status === "Berhasil" &&
                                typeof t.program === "string" &&
                          ...
                          const currentMilestone =
                            ZAKAT_MILESTONES.filter(
                              (m) => totalZakat >= m.amount,
                            ).pop() || ZAKAT_MILESTONES[0];
                          const Icon = currentMilestone.icon;
                      ...
                      {(() => {
                        ...
                        const nextMilestone =
                          ZAKAT_MILESTONES.find(
                            (m) => m.amount > currentMilestone.amount,
                          ) || null;
                        const progress = nextMilestone
                          ? Math.min(
                              ((totalZakat - currentMilestone.amount) /
                                (nextMilestone.amount -
                                  currentMilestone.amount)) *
                                100,
                              100,
                            ...
                            <div className="flex justify-between items-center text-[11px] font-bold">
                              ...
                              {nextMilestone && (
                                <span className="text-emerald-600 uppercase tracking-widest">
                                  ...
                                  <span className="text-slate-700 dark:text-slate-200">
                                    {formatCurrency(
                                      nextMilestone.amount - totalZakat,
                                    )}
                                  </span>{" "}
                                  lagi ke{" "}
                    ...
                    <div className="flex items-center gap-3 mb-6 px-1">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-500 hidden md:block">
                          Apresiasi khusus atas keikhlasan & konsistensi Anda
                          dalam berbagi.
                        </p>
                      </div>
                    </div>
                      ...
                      {(() => {
                        ...
                        const badges = [
                          ...
                          },
                          {
                            ...
                            unlocked: userDonations.some(
                              (t: any) =>
                                typeof t.program === "string" &&
                                t.program.toLowerCase().includes("yatim"),
                            ),
                          },
                          {
                            id: "istiqomah",
                            ...
                            border:
                              "border-[#1799dc]/30 dark:border-[#1799dc]/20",
                            unlocked:
                              userDonations.filter(
                                (t: any) => t.status === "Berhasil",
                              ).length >= 3,
                        ...
                        return badges.map((badge) => (
                          <div
                            key={badge.id}
                            className={`p-5 md:p-6 rounded-3xl border relative overflow-hidden transition-all duration-300 ${badge.unlocked ? `bg-white dark:bg-slate-800 shadow-sm ${badge.border} hover:scale-[1.02] hover:shadow-md cursor-default` : "bg-slate-50 dark:bg-slate-800/40 border-dashed border-slate-200 dark:border-slate-700 grayscale opacity-60"}`}
                          >
                            {badge.unlocked && (
                              <div
                                className={`absolute top-0 right-0 w-32 h-32 rounded-full -mr-16 -mt-16 opacity-50 ${badge.bg}`}
                              ></div>
                            )}
                            <div
                              className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-4 ${badge.unlocked ? badge.bg : "bg-slate-200 dark:bg-slate-700"}`}
                            >
                              <badge.icon
                                className={`w-7 h-7 ${badge.unlocked ? badge.color : "text-slate-400"}`}
                              />
                            </div>
                            <h4 className="font-bold text-slate-800 dark:text-slate-100 mb-1.5 md:text-lg">
                              {badge.name}
                            </h4>
                            <p className="text-[11px] md:text-xs text-slate-500 dark:text-slate-400 leading-snug">
                              {badge.desc}
                            </p>
                            {!badge.unlocked && (
                  ...
                  <div className="mt-6">
                    {(() => {
                      const totalSemua = userDonations
                        .filter((t: any) => t.status === "Berhasil")
                        .reduce((acc: any, curr: any) => acc + curr.amount, 0);
                      return (
                        <PohonKebaikanInteractive totalDonation={totalSemua} />
                      );
                    })()}
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden mb-12 transition-colors duration-300">
                        ...
                        {(historyTab === "Semua"
                          ...
                          >
                            <td className="p-4 whitespace-nowrap">
                              ...
                              <div className="text-[10px] space-x-1 font-mono text-slate-400">
                                {txn.id}
                              </div>
                            </td>
                            <td className="p-4 min-w-[200px]">
                                ...
                                <div className="mt-3 space-y-2">
                                  ...
                                  <div className="h-1.5 w-full bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden">
                                    <motion.div
                                      initial={{ width: 0 }}
                                      animate={{
                                        width: txn.program.includes("Gaza")
                                          ? "45%"
                                          : "100%",
                                      }}
                              ...
                              {txn.impact && (
                                <div className="mt-2 bg-primary-50 dark:bg-primary-900/10 border border-primary-100 dark:border-primary-800/50 rounded-lg p-2 text-xs flex items-start gap-2">
                                  ...
                                  <p className="text-primary-800 dark:text-primary-300/80 leading-relaxed max-w-sm">
                                    {txn.impact}
                                  </p>
                                </div>
                              )}
                            ...
                            <td className="p-4 text-center">
                              <span
                                className={`text-[10px] font-black uppercase px-2.5 py-1 rounded-full ${txn.status === "Berhasil" ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400" : "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400"}`}
                              >
                                {txn.status}
                              </span>
                            </td>
                  ...
                  <div className="md:hidden grid grid-cols-1 divide-y divide-slate-100 dark:divide-slate-700/50">
                    {(historyTab === "Semua"
                      ...
                      <div
                        key={txn.id}
                        className="p-4 flex flex-col gap-3 hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors"
                      >
                        <div className="flex items-start justify-between gap-4">
                          <div>
                            <div className="flex items-center gap-2 mb-1.5">
                              ...
                              <span
                                className={`text-[9px] font-black uppercase px-2 py-0.5 rounded-full ${txn.status === "Berhasil" ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400" : "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400"}`}
                              >
                                {txn.status}
                              </span>
                            </div>
                            <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100 mb-0.5 leading-snug">
                              {txn.program}
                            </h3>
                        ...
                        {txn.impact && (
                          <div className="bg-primary-50 dark:bg-primary-900/10 border border-primary-100 dark:border-primary-800/50 rounded-lg p-2.5 text-xs relative">
                            <div className="flex items-start gap-2">
                              <CheckCircle2 className="w-4 h-4 text-primary-500 shrink-0 mt-0.5" />
                              <div>
                                <strong className="text-primary-800 dark:text-primary-400 block mb-0.5 text-[10px] uppercase tracking-wider">
                                  Laporan Dampak
                                </strong>
                                <p className="text-primary-900 dark:text-primary-200/80 leading-relaxed">
                                  {txn.impact}
                                </p>
                              </div>
                            </div>
                ...
                <div className="mt-8 text-center bg-primary-900 text-white p-6 md:p-8 rounded-2xl relative overflow-hidden shadow-2xl">
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row items-center justify-between text-center md:text-left gap-6">
                    <div>
                      <h4 className="text-xl md:text-2xl font-extrabold text-[#1799dc] mb-2 tracking-tight">
                        Terus Tebar Kebaikan
                      </h4>
                      <p className="text-primary-200 font-medium text-sm md:text-base">
                        Masih banyak saudara kita yang menanti uluran tangan
                        sahabat.
                      </p>
                    </div>
                    <motion.button
        ...
        <Route
          path="/qurban"
          element={<QurbanPage onAddToCart={handleAddToCart} />}
        />
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="md:col-span-1">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-8">
                Lembaga Amil Zakat Nasional yang bertekad mensyiarkan dakwah di
                pelosok Nusantara melalui program pendayagunaan zakat yang
                inovatif dan terukur.
              </p>
              <div className="flex gap-4">
                <motion.a
                  href="#"
                  className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-[#1799dc] hover:text-white transition-colors duration-300"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <Facebook className="w-5 h-5" />
            ...
            <div>
              <h5 className="font-bold text-lg mb-8 text-slate-900 dark:text-white">
                Layanan Kami
              </h5>
              <ul className="flex flex-col gap-4 text-slate-600 dark:text-slate-400 text-sm">
                <li>
                  <motion.button
                    ...
                    className="hover:text-[#1799dc] dark:hover:text-[#2db2f5] transition-colors duration-300"
                  >
                    Kalkulator Zakat
                  </motion.button>
                </li>
          ...
          <div className="pt-10 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-8 text-xs text-slate-500 dark:text-slate-400">
              <motion.a
                href="#"
                className="hover:text-[#1799dc] transition-colors duration-300"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Kebijakan Privasi
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 relative">
            ...
            <div className="relative flex flex-col items-center justify-end h-[42px] w-14">
              ...
              <span className="text-[9px] font-bold tracking-tight text-slate-700 dark:text-slate-300 relative z-20">
                Donasi
              </span>
            </div>
              ...
              <div className="p-4 md:p-6 space-y-4 md:space-y-6 overflow-y-auto">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 pl-1">
                    Nomor telepon dgunakan untuk riwayat donasi dan
                    amaliyah/bacaan Qur'an.
                  </p>
                </div>
              </div>
                ...
                {cartItems.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-10 text-center">
                    ...
                    <h4 className="font-bold text-slate-700 dark:text-slate-300 mb-1">
                      Kantung Kebaikan Masih Kosong
                    </h4>
                    <p className="text-sm text-slate-500 dark:text-slate-500">
                      Mari temukan program kebaikan dan raih timbangan amal
                      terbaikmu.
                    </p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {cartItems.map((item, index) => (
                      <div
                        key={index}
                        className="flex gap-3 items-start border-b border-slate-100 dark:border-slate-700/50 pb-4"
                      >
                        <img
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-bold text-sm text-slate-800 dark:text-slate-200 line-clamp-2 leading-snug mb-1">
                            {item.program.title}
                          </h4>
                          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                            {item.program.category}
                          </span>
                          <div className="text-[#1799dc] font-black text-sm mt-1">
                            Rp {formatCurrencyForm(item.amount)}
                          </div>
                        </div>
                        <motion.button
                          whileTap={{ scale: 0.9 }}
                    ...
                    <div className="pt-4 space-y-4">
                      ...
                      <motion.button
                        ...
                        onClick={() => {
                          ...
                          setDonationAmount(
                            formatCurrencyForm(total.toString()),
                          );
              ...
              <div className="p-4 md:p-6 flex-1 overflow-y-auto">
                <div className="flex justify-between items-start mb-3 md:mb-5 border-b border-slate-100 dark:border-slate-700/50 pb-2 md:pb-4">
                  <div className="pr-4">
                    <h3
                      ...
                      className="text-lg md:text-xl font-extrabold text-[#1799dc] dark:text-[#2db2f5] mb-0.5 tracking-tight"
                    >
                      {isDonationSuccess
                ...
                {isDonationSuccess ? (
                  ...
                  >
                    ...
                    <h4 className="text-3xl font-extrabold text-emerald-600 dark:text-emerald-400 mb-1 leading-tight">
                      Alhamdulillah!
                    </h4>
                    <p className="text-slate-800 dark:text-white font-bold text-lg mb-1">
                      Jazakumullahu Khairan Sahabat Dakwah
                    </p>
                    ...
                    <div className="flex flex-col items-center gap-1 mb-4">
                      <p className="text-emerald-700 dark:text-emerald-400 font-arabic text-xl md:text-2xl mt-1 leading-relaxed text-center px-4">
                        أَخْلَفَ اللَّهُ عَلَيْكَ فِيمَا أَنْفَقْتَ، وَبَارَكَ
                        لَكَ فِيمَا أَبْقَيْتَ
                      </p>
                      <p className="text-slate-500 dark:text-slate-300 text-[13px] px-2 leading-relaxed italic text-center">
                        "Semoga Allah memberikan pahala atas apa yang engkau
                    ...
                    <div className="w-full bg-emerald-50/80 dark:bg-emerald-900/20 rounded-2xl p-4 mb-4 border border-emerald-100 dark:border-emerald-800/30 relative overflow-hidden text-center shadow-inner scale-95 origin-center">
                      ...
                      <p className="text-[12px] md:text-[13px] text-emerald-800 dark:text-emerald-200 font-medium italic leading-relaxed">
                        "Sedekah itu memadamkan panasnya kubur bagi pelakunya,
                        dan setiap mukmin akan bernaung di bawah naungan
                        sedekahnya pada hari kiamat." (HR. Thabrani)
                      </p>
                    </div>
                        ...
                        qurbanName && (
                          <div className="pt-2 border-t border-slate-200 dark:border-slate-600/50 flex flex-col gap-1.5 mt-2">
                            <div className="flex items-center justify-between">
                              ...
                              <span className="text-xs md:text-[13px] font-bold text-slate-800 dark:text-slate-200">
                                {qurbanName}
                              </span>
                            </div>
                            <div className="flex items-center justify-between">
                            ...
                            {qurbanLocation && (
                              <div className="flex items-center justify-between">
                                ...
                                <span className="text-xs md:text-[13px] font-bold text-slate-800 dark:text-slate-200 truncate pl-2">
                                  {QURBAN_LOCATIONS.find(
                                    (loc) => loc.id === qurbanLocation,
                                  )?.name || qurbanLocation}
                                </span>
                              </div>
                            )}
                    ...
                    <div className="grid grid-cols-2 gap-3 w-full mb-4">
                      ...
                      <motion.button
                        className="transition-all duration-300 flex items-center justify-center gap-2 py-3 px-4 bg-slate-100 dark:bg-slate-700/80 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-600 border border-slate-200 dark:border-slate-600 rounded-xl font-bold text-sm hover:-translate-y-0.5 transition-all duration-300 hover:shadow-lg"
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.95 }}
                      >
                  ...
                  >
                    <div className="bg-primary-50 dark:bg-primary-900/20 p-5 rounded-2xl border border-primary-100 dark:border-primary-800/50 text-center">
                      ...
                      <h4 className="text-lg font-bold text-slate-800 dark:text-slate-100 mb-1">
                        {PAYMENT_INSTRUCTIONS[selectedPaymentMethod]?.title ||
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2.5">
                        {(
                          PAYMENT_INSTRUCTIONS[selectedPaymentMethod]?.steps ||
                          []
                        ).map((step: string, i: number) => (
                          <div
                            key={i}
                            className="flex gap-3 items-start bg-slate-50 dark:bg-slate-900/50 p-3.5 rounded-xl border border-slate-100 dark:border-slate-800/50 transition-all hover:border-primary-200"
                          >
                  ...
                  <motion.form
                    ...
                    onSubmit={async (e) => {
                      ...
                      try {
                        ...
                        console.error(err);
                        alert(
                          err.message || "Terjadi kesalahan sistem pembayaran.",
                        );
                      }
                    }}
                  >
                    <div className="space-y-3">
                      <label className="flex items-center gap-2 text-[10px] md:text-[11px] font-black text-primary-600 dark:text-primary-400 uppercase tracking-[0.2em] px-1">
                        ...
                        {selectedProgramForDonation.category === "Qurban"
                          ? "Pilih Timbangan Amal Terbaik Anda"
                          : "Niatkan Sedekah Terbaik"}
                      </label>
                      ...
                      <div className="relative group">
                        ...
                        <input
                          ...
                          className="w-full pl-9 pr-4 py-2 bg-slate-50/50 dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-700 focus:bg-white dark:focus:bg-slate-800 transition-all font-black text-base text-slate-900 dark:text-white"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-slate-50/50 rounded-xl border border-slate-200 text-sm font-medium"
                        />
                      </div>
                      <div className="space-y-1">
                        <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest px-1">
                      ...
                      <div className="flex overflow-x-auto gap-2 pb-2 snap-x hide-scrollbar -mx-1 px-1">
                        {PAYMENT_METHODS.filter((method) =>
                          ...
                          PAYMENT_METHODS.filter((method) =>
                            ...
                            >
                              <div
                                className={`w-8 h-8 rounded-lg flex items-center justify-center p-1 shrink-0 ${selectedPaymentMethod === method.id ? "bg-white" : "bg-slate-50 border border-slate-100 dark:border-slate-700 dark:bg-slate-900"}`}
                              >
                                <img
                                  src={method.icon}
                                  alt={method.name}
                              ...
                              <div className="flex flex-col items-start leading-none text-left min-w-0">
                                <span
                                  className={`font-bold text-[11px] md:text-[12px] truncate w-full ${selectedPaymentMethod === method.id ? "text-primary-700 dark:text-primary-400" : "text-slate-700 dark:text-slate-300"}`}
                                >
                                  {method.name}
                                </span>
                                <span
                                  className={`text-[9px] truncate w-full ${selectedPaymentMethod === method.id ? "text-primary-500" : "text-slate-400"}`}
                                >
                                  {method.desc}
                                </span>
                              </div>
                          ...
                          <div className="w-full text-center py-4 flex flex-col items-center justify-center">
                            ...
                            <span className="text-xs font-medium text-slate-500">
                              Metode \'{paymentSearchQuery}\' tidak ditemukan
                            </span>
                          </div>
                        )}
                      </div>
                    ...
                    {selectedProgramForDonation.category === "Qurban" && (
                      <div className="bg-primary-50/50 dark:bg-primary-900/10 p-3.5 md:p-4 rounded-xl border border-primary-100 dark:border-primary-900/30 space-y-4">
                        <div>
                          <label
                            className="block text-[11px] md:text-[13px] font-bold text-slate-700 dark:text-slate-300 mb-1 md:mb-1.5 uppercase tracking-wider"
                            htmlFor="qurban-name"
                          >
                            Atas Nama Siapa Qurban Ini Diniatkan?{" "}
                        ...
                        <div>
                          <label
                            className="block text-[11px] md:text-[13px] font-bold text-slate-700 dark:text-slate-300 mb-1 md:mb-1.5 uppercase tracking-wider"
                            htmlFor="qurban-location"
                          >
                            Pilih Wilayah Penyaluran Qurban{" "}
                            <span className="text-red-500">*</span>
                          </label>
                          <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 md:pl-4 flex items-center pointer-events-none">
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setQurbanLocation(e.target.value)
                              }
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <select
                                ...
                                value={qurbanAnimal}
                                onChange={(e) =>
                                  setQurbanAnimal(e.target.value)
                                }
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <select
                                ...
                                onChange={(e) =>
                                  setQurbanProcessing(e.target.value)
                                }
                                className="w-full px-3 py-2 md:py-3 bg-white dark:bg-slate-900/50 rounded-lg md:rounded-xl border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all text-sm md:text-base appearance-none cursor-pointer"
                              >
                                <option value="" disabled>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2">
                              <motion.button
                                ...
                                type="button"
                                onClick={() =>
                                  setQurbanQty(Math.max(1, qurbanQty - 1))
                                }
                                className="transition-all duration-300 w-10 h-10 md:w-12 md:h-12 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg flex items-center justify-center hover:bg-slate-50 transition-colors text-xl font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:brightness-110 active:scale-95"
                              >
                                -
                              </motion.button>
                              ...
                              <motion.button
                                ...
                                whileHover={{ scale: 1.05 }}
                                type="button"
                                onClick={() => setQurbanQty(qurbanQty + 1)}
                                className="transition-all duration-300 w-10 h-10 md:w-12 md:h-12 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg flex items-center justify-center hover:bg-slate-50 transition-colors text-xl font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:brightness-110 active:scale-95"
                              >
                                +
                              </motion.button>
                          ...
                          <div className="flex-1 flex flex-col justify-end">
                            <label className="flex items-center gap-2.5 p-2.5 md:p-3 bg-white dark:bg-slate-800 border items-center border-slate-200 dark:border-slate-700 rounded-lg cursor-pointer hover:bg-slate-50 transition-colors group">
                              <input
                                ...
                                onChange={(e) =>
                                  setQurbanForParents(e.target.checked)
                                }
                    ...
                    <div className="space-y-2">
                      <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest px-1 flex justify-between items-center">
                        ...
                        <span className="text-slate-400 capitalize normal-case text-[9px] font-medium italic">
                          Tampil live di Dinding Doa
                        </span>
                      </label>
                      <div className="relative">
                        <textarea
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        <>
                          {selectedProgramForDonation.category === "Qurban"
                            ? "Bismillah, Siapkan Kendaraan Syurga Anda Sekarang"
                            : "Bismillah, Tunaikan Sedekah"}
            ...
            >
              <div className="bg-primary-50 dark:bg-primary-900/20 p-4 border-b border-primary-100 dark:border-primary-800/50 flex justify-between items-center sticky top-0 z-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Hitung & tunaikan kewajiban Zakat
                    </p>
                  </div>
                </div>
                <motion.button
              ...
              <div className="p-5 overflow-y-auto custom-scrollbar flex-1">
                <div className="mb-5 p-3.5 bg-blue-50/50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-800/30 flex items-center justify-between group cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
                  ...
                  {isFetchingGold ? (
                    <span className="text-[10px] bg-blue-100 dark:bg-blue-800/50 text-blue-600 dark:text-blue-300 px-2.5 py-1 rounded-full font-bold animate-pulse">
                      Memperbarui
                    </span>
                  ) : (
                    <span className="text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 px-2.5 py-1 rounded-full font-bold group-hover:bg-blue-100 dark:group-hover:bg-blue-800/50 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors">
                      Manual/Auto
                    </span>
                  )}
                </div>
                ...
                <div className="space-y-4">
                    ...
                    >
                            ...
                            <div key={i}>
                              ...
                              <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                  <span className="text-slate-400 group-focus-within:text-primary-500 font-bold text-sm transition-colors">
                                    Rp
                                  </span>
                                </div>
                                <input
                      ...
                      {zakatTab === "maal" && (
                        <>
                          {[
                            ...
                            {
                              label: "Nilai Emas / Perak",
                              val: maalEmas,
                              set: setMaalEmas,
                            },
                            {
                              label: "Properti / Kendaraan (Non-primer)",
                              val: maalProperti,
                              set: setMaalProperti,
                            },
                            {
                            ...
                            <div key={i}>
                              ...
                              <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                  <span
                                    className={`font-bold text-sm transition-colors ${f.isDeduction ? "text-red-400 group-focus-within:text-red-500" : "text-slate-400 group-focus-within:text-primary-500"}`}
                                  >
                                    Rp
                                  </span>
                                </div>
                      ...
                      {zakatTab === "saham" && (
                        <>
                          {[
                            {
                              label: "Nilai Saham Saat Ini",
                              val: sahamNilai,
                              set: setSahamNilai,
                            },
                            {
                              label: "Keuntungan / Dividen",
                              val: sahamDividen,
                              set: setSahamDividen,
                            },
                          ].map((f, i) => (
                        ...
                        <>
                          <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-xl border border-amber-200 dark:border-amber-700/50 mb-4 bg-opacity-50">
                            <p className="text-xs text-amber-800 dark:text-amber-400 leading-relaxed">
                              <b>Zakat Rikaz</b> (Harta Temuan/Karun) tidak
                              memiliki syarat nisab maupun haul (waktu
                              kepemilikan). Kewajiban zakatnya adalah{" "}
                              <b>20% (Khums)</b> dan harus segera dikeluarkan
                              saat harta tersebut ditemukan.
                            </p>
                          </div>
                          {[
                            {
                              label: "Nilai Harta Temuan (Rikaz)",
                              val: rikazNilai,
                              set: setRikazNilai,
                            },
                          ].map((f, i) => (
                      ...
                      {zakatTab === "fidyah" && (
                        <>
                          <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-xl border border-amber-200 dark:border-amber-700/50 mb-4 bg-opacity-50">
                            <p className="text-xs text-amber-800 dark:text-amber-400 leading-relaxed">
                              <b>Fidyah</b> dibayarkan untuk mengganti puasa
                              Ramadhan yang ditinggalkan (bagi yang tidak mampu
                              mengganti/qadha puasa). <b>Kafarat</b> adalah
                              tebusan atas pelanggaran (seperti sumpah).
                            </p>
                          </div>
                          <div className="mb-4">
                            <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 uppercase tracking-wider">
                          ...
                          {[
                            ...
                            },
                            {
                              label:
                                fidyahType === "fidyah"
                                  ...
                                  : "Harga Kafarat (Makan 10 Orang Miskin)",
                              val: fidyahRate,
                              set: setFidyahRate,
                              prefix: "Rp",
                            },
                            ...
                            <div key={i}>
                              <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5 uppercase tracking-wider mt-4">
                                {f.label}
                              </label>
                              <div className="relative group">
                                {f.prefix && (
                                ...
                                <input
                                  type="text"
                                  value={
                                    f.prefix ? formatCurrencyForm(f.val) : f.val
                                  }
                                  onChange={(e) =>
                                    f.set(e.target.value.replace(/\D/g, ""))
                                  }
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900/40 p-4 rounded-xl border border-slate-100 dark:border-slate-800/50 shadow-inner mt-6 space-y-4">
                    {totalAsset > 0 && (
                      <div>
                        <h5 className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2 border-b border-slate-200 dark:border-slate-700/50 pb-1.5 flex items-center gap-1.5">
                          <FileText className="w-3.5 h-3.5" /> Rincian Sumber
                          Dana
                        </h5>
                        <div className="space-y-1.5 mb-3 px-1">
                          {zakatTab === "penghasilan" && (
                            <>
                              {parseInt(zakatIncome.replace(/\D/g, "")) > 0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Pendapatan
                                  </span>
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(zakatIncome)}
                                  </span>
                                </div>
                              )}
                              {parseInt(zakatBonus.replace(/\D/g, "")) > 0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Bonus/THR
                                  </span>
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(zakatBonus)}
                                  </span>
                                </div>
                              )}
                            </>
                          ...
                          {zakatTab === "maal" && (
                            <>
                              {parseInt(maalTabungan.replace(/\D/g, "")) >
                                0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Tabungan
                                  ...
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(maalTabungan)}
                                  </span>
                                </div>
                              )}
                              {parseInt(maalEmas.replace(/\D/g, "")) > 0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Emas/Perak
                                  </span>
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(maalEmas)}
                                  </span>
                                </div>
                              )}
                              {parseInt(maalProperti.replace(/\D/g, "")) >
                                0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Properti/Kendaraan
                                  ...
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(maalProperti)}
                                  </span>
                                </div>
                              )}
                              {parseInt(maalHutang.replace(/\D/g, "")) > 0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Hutang
                                  </span>
                                  <span className="font-medium text-red-500">
                                    -Rp {formatCurrencyForm(maalHutang)}
                                  </span>
                                </div>
                              )}
                            </>
                          ...
                          {zakatTab === "perdagangan" && (
                            <>
                              {parseInt(dagangModal.replace(/\D/g, "")) > 0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Modal Diputar
                                  </span>
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(dagangModal)}
                                  </span>
                                </div>
                              )}
                              {parseInt(dagangUntung.replace(/\D/g, "")) >
                                0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Keuntungan
                                  ...
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(dagangUntung)}
                                  </span>
                                </div>
                              )}
                              {parseInt(dagangPiutang.replace(/\D/g, "")) >
                                0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Piutang Lancar
                                  ...
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(dagangPiutang)}
                                  </span>
                                </div>
                              )}
                              {parseInt(dagangHutang.replace(/\D/g, "")) >
                                0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Hutang
                                  ...
                                  <span className="font-medium text-red-500">
                                    -Rp {formatCurrencyForm(dagangHutang)}
                                  </span>
                                </div>
                              )}
                            </>
                          ...
                          {zakatTab === "saham" && (
                            <>
                              {parseInt(sahamNilai.replace(/\D/g, "")) > 0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Nilai Saham
                                  </span>
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(sahamNilai)}
                                  </span>
                                </div>
                              )}
                              {parseInt(sahamDividen.replace(/\D/g, "")) >
                                0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Dividen
                                  ...
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(sahamDividen)}
                                  </span>
                                </div>
                              )}
                            </>
                          ...
                          {zakatTab === "rikaz" && (
                            <>
                              {parseInt(rikazNilai.replace(/\D/g, "")) > 0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Nilai Temuan
                                  </span>
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(rikazNilai)}
                                  </span>
                                </div>
                              )}
                            </>
                          ...
                          {zakatTab === "fidyah" && (
                            <>
                              {parseInt(fidyahDays.replace(/\D/g, "")) > 0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    {fidyahType === "fidyah"
                                      ? "Hari Ditinggalkan"
                              ...
                              {parseInt(fidyahRate.replace(/\D/g, "")) > 0 && (
                                <div className="flex justify-between text-xs">
                                  <span className="text-slate-600 dark:text-slate-300">
                                    Tarif per{" "}
                                    {fidyahType === "fidyah"
                                  ...
                                  <span className="font-medium text-slate-800 dark:text-slate-200">
                                    Rp {formatCurrencyForm(fidyahRate)}
                                  </span>
                                </div>
                              )}
                            </>
                    ...
                    {zakatTab !== "rikaz" && zakatTab !== "fidyah" && (
                      <div>
                        <h5 className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2 border-b border-slate-200 dark:border-slate-700/50 pb-1.5 flex items-center gap-1.5">
                          <Calculator className="w-3.5 h-3.5" /> Detail
                          Perhitungan Nisab
                        </h5>
                        <div className="space-y-1.5 px-1 text-xs">
                          {zakatTab === "penghasilan" && (
                            <div className="mb-2 text-[10px] text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800/50 p-2 rounded border border-slate-100 dark:border-slate-700/50 leading-relaxed">
                              Nisab zakat penghasilan adalah senilai 85 gram
                              emas per tahun. Jika dibayar per bulan, nisab
                              dihitung dari nilai 85 gram emas dibagi 12 bulan.
                              Zakat yang harus dikeluarkan adalah 2,5% dari
                              total penghasilan.
                            </div>
                          )}
                          {zakatTab === "maal" && (
                            <div className="mb-2 text-[10px] text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800/50 p-2 rounded border border-slate-100 dark:border-slate-700/50 leading-relaxed">
                              Nisab zakat maal (harta simpanan) adalah senilai
                              85 gram emas. Harta yang wajib dizakati adalah
                              yang telah mencapai haul (1 tahun) dan dihitung
                              setelah dikurangi hutang jatuh tempo. Nilai
                              zakatnya adalah 2,5%.
                            </div>
                          )}
                          {zakatTab === "perdagangan" && (
                            <div className="mb-2 text-[10px] text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800/50 p-2 rounded border border-slate-100 dark:border-slate-700/50 leading-relaxed">
                              Nisab zakat perdagangan sama dengan zakat maal,
                              yaitu senilai 85 gram emas. Dihitung dari
                              keseluruhan aset berputar (Modal + Untung +
                              Piutang) dikurangi hutang jatuh tempo. Zakat yang
                              dikeluarkan sebesar 2,5%.
                            </div>
                          )}
                          {zakatTab === "saham" && (
                            <div className="mb-2 text-[10px] text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800/50 p-2 rounded border border-slate-100 dark:border-slate-700/50 leading-relaxed">
                              Nisab zakat saham disamakan dengan zakat maal (85
                              gram emas). Nilai aset dihitung dari nilai wajar
                              saham (saat haul tiba) ditambah total dividen yang
                              diterima. Zakat yang dikeluarkan adalah 2,5%.
                            </div>
                          )}
                          <div className="flex justify-between mt-2">
                            ...
                            <span className="font-medium text-slate-800 dark:text-slate-200">
                              Rp {formatCurrencyForm(goldPrice)} / gr
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-slate-800 dark:text-slate-200">
                              ...
                              {formatCurrencyForm(
                                (
                                  parseInt(goldPrice.replace(/\D/g, "")) * 85
                                ).toString(),
                              )}{" "}
                              / tahun
                            </span>
                          ...
                          {zakatTab === "penghasilan" && (
                            <div className="flex justify-between">
                              <span className="text-slate-600 dark:text-slate-300">
                                Nisab per Bulan (85gr / 12)
                              </span>
                              <span className="font-medium text-slate-800 dark:text-slate-200">
                                Rp{" "}
                                {formatCurrencyForm(
                                  Math.floor(
                                    (parseInt(goldPrice.replace(/\D/g, "")) *
                                      85) /
                                      12,
                                  ).toString(),
                                )}{" "}
                    ...
                    <div
                      className={`${totalAsset > 0 || (zakatTab !== "rikaz" && zakatTab !== "fidyah") ? "pt-3 border-t border-slate-200 dark:border-slate-700/50 mt-2" : ""}`}
                    >
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                          {zakatTab === "fidyah"
                            ? "Total Tagihan"
                            : "Total Harta Terhitung"}
                        </span>
                        <span className="text-sm font-bold text-primary-600 dark:text-primary-500">
                          Rp {formatCurrencyForm(totalAsset.toString())}
                        </span>
                      </div>
                      {zakatTab !== "fidyah" && (
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-[11px] font-medium text-slate-700 dark:text-slate-300">
                            Rp{" "}
                            {formatCurrencyForm(
                              Math.floor(requiredNisab).toString(),
                            )}
                          </span>
                        </div>
                      )}
                  ...
                  {isEligibleZakat ? (
                    ...
                    >
                      ...
                      <p className="text-xs font-extrabold text-emerald-800 dark:text-emerald-400 uppercase tracking-widest mb-1.5 flex items-center justify-center gap-1.5">
                        ...
                        {zakatTab === "fidyah"
                          ? "Wajib Dibayarkan"
                          : `Wajib Zakat (${zakatTab === "rikaz" ? "20%" : "2.5%"})`}
                      </p>
                      <h4 className="text-3xl font-black text-emerald-600 dark:text-emerald-400 mb-2 drop-shadow-sm">
                        Rp {formatCurrencyForm(zakatToPay.toString())}
                      </h4>
                      <p className="text-xs font-medium text-emerald-700/80 dark:text-emerald-400/80 leading-relaxed px-4">
                        {zakatTab === "fidyah"
                          ? fidyahType === "fidyah"
                            ? "Tunaikan fidyah Anda untuk mengganti puasa yang ditinggalkan."
                            : "Tunaikan kafarat Anda sebagai tebusan atas pelanggaran."
                          : zakatTab === "rikaz"
                            ? "Rikaz (Harta Temuan) wajib dikeluarkan zakatnya sebesar 20% tanpa syarat nisab dan haul."
                            : "Alhamdulillah, harta Anda telah mencapai nisab. Tunaikan segera untuk membersihkan dan memberkahi harta Anda."}
                      </p>
                    </motion.div>
                    ...
                    >
                      <p className="text-xs font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
                        Harta Anda belum mencapai batas nisab wajib zakat. Anda
                        tetap bisa meraih keutamaan berbagi dengan menunaikan{" "}
                        <b>Infak</b> atau <b>Sedekah</b>.
                      </p>
                    </motion.div>
                  ) : null}
                </div>
