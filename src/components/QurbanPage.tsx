...
export const QurbanPage = ({ onAddToCart, t }: { onAddToCart?: (p: any, amt: string) => void, t: (key: string) => string }) => {
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        ...
        <div className="flex justify-center mb-10">
          <div className="bg-white dark:bg-slate-800 p-1 rounded-2xl md:rounded-full shadow-lg border border-slate-100 dark:border-slate-700 grid grid-cols-4 gap-1 w-full md:w-auto">
            ...
            >
              <Sparkles className="w-3.5 h-3.5 hidden sm:block" /> {t('tabungan')}
            </button>
            <button 
            ...
            >
              <Heart className="w-3.5 h-3.5 hidden sm:block" /> {t('dampak')}
            </button>
          </div>
        </div>
                  ...
                  <div className="grid lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 mb-2 p-1">
                        ...
                        <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-400">{t('identitas_penunaian')}</h3>
                      </div>
                      
                      <div className="grid sm:grid-cols-2 gap-3">
                        <div className="space-y-1.5">
                          <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1">{t('nama_lengkap')}</label>
                          <input required type="text" value={donorName} onChange={e => setDonorName(e.target.value)} placeholder={t('nama_anda')} className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900/50 rounded-xl border border-slate-200 dark:border-slate-700 outline-none text-sm font-black shadow-sm focus:border-blue-400" />
                        </div>
                        <div className="space-y-1.5">
                          <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1">{t('wa_kontak')}</label>
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1">{t('niat_qurban')}</label>
                        <div className="relative group">
                          <input 
                            type="text" 
                            value={isForParent ? t('ortu_tercinta') : qurbanFor}
                        ...
                        <button type="button" onClick={() => setIsForParent(!isForParent)} className={`text-[10px] font-bold flex items-center gap-1.5 mt-1 transition-colors ${isForParent ? 'text-emerald-500' : 'text-slate-400 hover:text-emerald-500'}`}>
                          ...
                          {isForParent ? t('persembahan_mulia') : t('pilih_hadiah_ortu')}
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 mb-2 p-1">
                        ...
                        <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-400">{t('pilihan_qurban_wilayah')}</h3>
                      </div>
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest pl-1">{t('wilayah_penyaluran_label')}</label>
                              ...
                              <>
                                ...
                                >
                                  <div className="bg-slate-50 dark:bg-slate-900/80 px-4 py-2 text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] sticky top-0 z-10 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                                    <span>{t('pilih_titik_distribusi')}</span>
                                    <span className="text-[#1799dc] text-[7px]">{selectedRegion === 'pelosok' ? `📍 ${t('lokal')}` : `🌐 ${t('global')}`}</span>
                                  </div>
                                      ...
                                      >
                                        ...
                                        <div className="space-y-1">
                                          ...
                                          <div className="flex justify-between text-[7px] font-black uppercase text-slate-400">
                                            <span>{t('sisa_kuota')}: {prog.quota - prog.filled}</span>
                                            <span className={progress > 90 ? 'text-red-500' : 'text-[#1799dc]'}>{Math.round(progress)}% {t('terisi')}</span>
                                          </div>
                                        </div>
                                      </div>
                                    );
                      ...
                      >
                         <Info className="w-3.5 h-3.5" /> {t('lihat_detail_program')}
                      </button>
                            ...
                            <div className="flex items-center justify-between mb-5 md:mb-6 relative z-10">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                  <h3 className="text-sm md:text-base font-black uppercase tracking-tight text-slate-800 dark:text-white leading-tight">{t('kawanan_kebaikan')}</h3>
                                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest leading-none mt-1">{qurbanQty} {t('ekor_kambing_pilihan')}</p>
                                </div>
                              </div>
                            </div>
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between mb-5 md:mb-6 relative z-10">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                  <h3 className="text-sm md:text-base font-black uppercase tracking-tight text-slate-800 dark:text-white leading-tight">{t('kawanan_utama')}</h3>
                                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest leading-none mt-1">{qurbanQty} {t('ekor_sapi_tangguh')}</p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="relative min-h-[140px] bg-slate-50/50 dark:bg-slate-950/50 rounded-[2rem] p-6 flex flex-wrap items-center justify-center gap-4 overflow-hidden">
                              <AnimatePresence>
                                {Array.from({ length: qurbanQty }).map((_, i) => (
                                  ...
                                  >
                                    ...
                                    <span className="text-[7px] font-black uppercase text-blue-500 tracking-[0.2em]">{t('pilihan')}</span>
                                    <motion.div 
                              ...
                              {qurbanQty === 0 && (
                                <p className="text-slate-400 text-xs font-bold uppercase tracking-widest italic font-mono text-center">{t('pilih_jumlah_sapi')}</p>
                              )}
                            </div>

                            <div className="mt-4 flex justify-center">
                              <p className="text-[10px] font-bold text-slate-500 uppercase tracking-tight text-center px-4 bg-slate-50 dark:bg-slate-800 py-1 rounded-full border border-slate-100 dark:border-slate-700">{t('sapi_utuh_desc')} <span className="text-blue-500 font-black">{selectedProgram.location}</span></p>
                            </div>
                          </motion.div>
                        )}
                      </AnimatePresence>
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between mb-5 md:mb-6 relative z-10">
                              <div className="flex items-center gap-3 md:gap-4">
                                ...
                                <div className="text-left">
                                  <h3 className="text-sm md:text-base font-black uppercase tracking-tight text-slate-800 dark:text-white leading-tight">{t('mosaik_kebaikan')}</h3>
                                  <div className="flex items-center gap-1.5 mt-0.5">
                                    <span className="flex h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" />
                                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest leading-none">{t('sapi_bagian_1_7')}</p>
                                  </div>
                                </div>
                              </div>
                              <motion.div 
                              ...
                              >
                                <span className="text-[8px] font-black text-orange-600 dark:text-orange-400 uppercase tracking-[0.1em] leading-none mb-0.5">{t('potensi')}</span>
                                <span className="text-[10px] font-black text-slate-700 dark:text-slate-200 leading-none tracking-tight">{t('pahala_abadi')}</span>
                              </motion.div>
                            </div>
                            ...
                            <div className="flex items-center justify-between mb-4 px-1">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                >
                                  ...
                                  <span className="text-[8px] font-black text-blue-500 uppercase tracking-widest leading-none">{t('sahabat')}</span>
                                </motion.div>
                              </div>
                            </div>
                            ...
                            <div className="space-y-5">
                              <div>
                                <p className="text-xs md:text-sm text-slate-600 dark:text-slate-400 font-medium leading-relaxed text-center px-2">
                                  {t('sedekah_terbaik_quote')} 
                                  <span className="text-[10px] mt-1.5 block text-slate-400 italic font-normal">{t('kepingan_niat_desc').replace('{location}', selectedProgram.location)}</span>
                                </p>
                              </div>
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                ...
                                >
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <p className="text-[8px] font-black text-emerald-600 uppercase tracking-tighter">{t('penerima_manfaat')}</p>
                                  </div>
                                ...
                                >
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <p className="text-[8px] font-black text-blue-600 uppercase tracking-tighter">{t('solidaritas')}</p>
                                  </div>
                                  <p className="text-[10px] font-bold text-slate-700 dark:text-slate-200 line-clamp-1">{t('bersama_donatur_lain').replace('{count}', (selectedProgram.filled % 7 || 6).toString())}</p>
                                </motion.div>
                              </div>
                              ...
                              <div className="relative pt-1 px-1">
                                <div className="flex justify-between items-center mb-2">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[8px] font-black text-slate-400 uppercase tracking-[0.2em]">{t('puzzle_progress')}</span>
                                  </div>
                                  <span className="text-[10px] font-black text-[#1799dc]">{Math.round((((selectedProgram.filled % 7) || 4) / 7) * 100)}% {t('menyatu')}</span>
                                </div>
                                ...
                                <div className="mt-4 flex flex-wrap justify-center gap-4">
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">{t('sahabat_lain')}</span>
                                  </div>
                                  <div className="flex items-center gap-1.5">
                                    <div className="w-1.5 h-1.5 rounded-full bg-blue-600 shadow-[0_0_8px_rgba(37,99,235,0.5)]" />
                                    <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">{t('bagian_anda_label')}</span>
                                  </div>
                                  <div className="flex items-center gap-1.5">
                                    <div className="w-1.5 h-1.5 rounded-full bg-slate-200 dark:bg-slate-700" />
                                    <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">{t('mari_lengkapi')}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-900/50 p-2 rounded-xl border border-slate-100 dark:border-slate-800 shadow-inner mt-4">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-2">{t('jumlah_qurban')}</label>
                    ...
                    <div className="space-y-4">
                      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between px-2">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-left">
                            <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]">{t('total_donasi')}</p>
                        ...
                        <div className="text-right">
                          <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">{t('rincian_amanah')}</p>
                          <p className="text-xs font-black text-slate-700 dark:text-white px-2 py-1 bg-slate-100 dark:bg-slate-900 rounded-lg">
                            {qurbanQty} {selectedProgram.type === 'sapi_1_7' ? t('bagian_sapi') : t('ekor_kambing')}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          <span className="flex items-center gap-2">{t('tunaikan_qurban_sekarang')} <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" /></span>
                          <span className="text-[10px] opacity-70 uppercase tracking-[0.3em] mt-0.5">{t('selesaikan_checkout_aman')}</span>
                        </button>
                      </div>
                    </div>
                  </div>
            ...
            >
              <div className="p-6 md:p-10 lg:p-12">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white mb-3">{t('tabungan_qurban_title')}</h2>
                  <p className="text-slate-600 dark:text-slate-400 max-w-xl mx-auto text-sm md:text-base leading-relaxed">{t('tabungan_qurban_desc')}</p>
                </div>

                <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
                  <div className="space-y-6">
                    <div className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-700">
                      <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider mb-4 border-b border-slate-200 dark:border-slate-700 pb-3">{t('simulasi_tabungan')}</h3>
                      
                      <div className="space-y-4">
                        <div>
                          <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1 mb-1.5">{t('target_qurban_label')}</label>
                          <select 
                          ...
                          >
                            <option value={2500000}>{t('kambing_ekor')} - Rp 2.500.000</option>
                            <option value={2100000}>{t('sapi_bagian')} - Rp 2.100.000</option>
                            <option value={18000000}>{t('sapi_unit_utuh')} - Rp 18.000.000</option>
                          </select>
                        </div>
                        <div>
                          <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1 mb-1.5">{t('periode_tabungan')} ({t('bulan_label')})</label>
                        ...
                        <div className="pt-2">
                           <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-100 dark:border-emerald-800/50 flex flex-col items-center justify-center text-center">
                             <p className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mb-1">{t('setoran_per_bulan')}</p>
                             ...
                             <p className="text-xs text-emerald-600/70 dark:text-emerald-400/70 mt-1">~ Rp {formatCurrencyForm(Math.floor(tabunganTarget / tabunganMonths / 30).toString())} / {t('per_hari')}</p>
                           </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="space-y-4">
                       <h3 className="text-lg font-black text-slate-900 dark:text-white">{t('keuntungan_menabung_qurban')}</h3>
                       <ul className="space-y-3">
                         <li className="flex items-start gap-3">
                           ...
                           <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed"><strong className="text-slate-900 dark:text-white font-bold">{t('ringan_terencana')}.</strong> {t('ringan_terencana_desc')}</p>
                         </li>
                         <li className="flex items-start gap-3">
                           <div className="mt-0.5 w-5 h-5 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 flex items-center justify-center shrink-0">
                             <Check className="w-3 h-3 font-bold" />
                           </div>
                           <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed"><strong className="text-slate-900 dark:text-white font-bold">{t('autodebet_pintar')}.</strong> {t('autodebet_pintar_desc')}</p>
                         </li>
                         <li className="flex items-start gap-3">
                           <div className="mt-0.5 w-5 h-5 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 flex items-center justify-center shrink-0">
                             <Check className="w-3 h-3 font-bold" />
                           </div>
                           <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed"><strong className="text-slate-900 dark:text-white font-bold">{t('prioritas_hewan_terbaik')}.</strong> {t('prioritas_hewan_terbaik_desc')}</p>
                         </li>
                       </ul>
                    </div>

                    <button 
                      onClick={() => alert(t('fitur_segera_hadir'))}
                    ...
                    >
                      <span className="flex items-center gap-2">{t('mulai_tabungan_sekarang')} <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" /></span>
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5 md:p-8 relative overflow-hidden">
                ...
                <div className="max-w-2xl mx-auto text-center relative z-10">
                  ...
                  <h2 className="text-xl md:text-2xl font-black text-slate-900 dark:text-white mb-1">
                    {t('track_your_qurban_title')}
                  </h2>
                  <p className="text-slate-500 dark:text-slate-400 text-xs mb-6 italic">{t('track_your_qurban_desc')}</p>
                  ...
                  <form onSubmit={handleSearch} className="relative mb-8 max-w-md mx-auto">
                    ...
                    >
                      {searchStatus === 'loading' ? <Loader2 className="w-3 h-3 animate-spin" /> : t('lacak_button')}
                    </button>
                  </form>
                </div>
                    ...
                    >
                      <div className="bg-gradient-to-r from-[#1799dc]/5 to-transparent dark:from-[#1799dc]/10 dark:to-transparent border border-slate-100 dark:border-slate-800 rounded-2xl p-4 flex items-center gap-4">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">{t('pequrban_terdaftar')}</p>
                          ...
                          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1">
                            ...
                            <p className="text-[10px] text-blue-600 dark:text-blue-400 font-bold flex items-center gap-1 bg-blue-50 dark:bg-blue-900/20 px-1.5 py-0.5 rounded">
                               <Milestone className="w-3 h-3" /> {t('berat_hewan')}: 280-320 Kg
                            </p>
                          </div>
                        </div>
                      </div>
